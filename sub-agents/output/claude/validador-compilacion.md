---
name: validador-compilacion
description: "Verifica compilación y tests. Agnóstico al lenguaje: detecta tipo de proyecto y ejecuta comandos apropiados."
tools: Read, Search, Glob, Grep, Bash
model: haiku
color: orange
---
