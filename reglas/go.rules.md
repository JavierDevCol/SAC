...
# =============================================================================
convenciones:
  estructura: "cmd/, internal/, pkg/, api/"
  naming: "lowercase paquetes, PascalCase exports, camelCase privados"
    drivers:
    ...
    caracteristicas:
      - "Auto migrations"
      - "Associations (Has One, Has Many, etc.)"
      - "Hooks (BeforeCreate, AfterUpdate, etc.)"
      - "Transactions"
  
  sqlx:
    detectar: "github.com/jmoiron/sqlx"
    significa: "sqlx - Extensiones sobre database/sql"
    caracteristicas:
      - "Named parameters"
      - "Struct scanning"
      - "In-clause expansion"
    nota: "Más control que ORM, menos boilerplate que sql puro"
  
  sqlc:
    detectar: "github.com/sqlc-dev/sqlc"
    significa: "sqlc - Genera código Go desde SQL"
    config: "sqlc.yaml"
    caracteristicas:
      - "Type-safe queries"
  ...
  ent:
    detectar: "entgo.io/ent"
    significa: "Ent - Entity framework de Facebook"
    caracteristicas:
      - "Schema as code"
      - "Graph traversal"
      - "Code generation"
  ...
  bun:
    detectar: "github.com/uptrace/bun"
    significa: "Bun - ORM moderno y ligero"
    caracteristicas:
      - "SQL-first"
      - "Struct mapping"
      - "Migrations"
  ...
  pgx:
    detectar: "github.com/jackc/pgx"
    significa: "pgx - Driver PostgreSQL nativo"
    nota: "Driver de bajo nivel, muy performante"
  
  mongo_driver:
    detectar: "go.mongodb.org/mongo-driver"
    significa: "Driver oficial de MongoDB"
  
  redis:
    detectar: "github.com/redis/go-redis"
    significa: "go-redis - Cliente Redis"
    alternativa: "github.com/go-redis/redis (legacy import)"
